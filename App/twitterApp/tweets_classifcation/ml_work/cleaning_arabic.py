...
def one_string_stop_words(sentence):
    ...
    file_dir1 =  'tweets_classifcation/ml_work/stop_words/nltk_stop_words_handle.txt'
    file_di2 = 'tweets_classifcation/ml_work/stop_words/stop_list1.txt'
    file_di3 ='tweets_classifcation/ml_work/stop_words/updated_stop_words.txt'
